...
double hRMS16  = 0.5;
F1D f1p16 = new F1D("EB Start Time Electron Center", "[amp]*gaus(x,[peak],[sigma])+[p0]+[p1]*x+[p2]*x*x", hMean16-1,hMean16+1);
...
System.out.println("WARNING: "+hMean16+" "+hRMS16);
...
double hRMS18  = 0.5;
F1D f1p18 = new F1D("EB Start Time Proton Center", "[amp]*gaus(x,[peak],[sigma])+[p0]+[p1]*x+[p2]*x*x",hMean18-1 ,hMean18+1);
